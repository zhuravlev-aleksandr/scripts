#!/usr/bin/env bash
# create-template.sh — Download a cloud image, customise it, and import as a Proxmox template
#
# Usage:
...
# Examples:
#   ./create-template.sh
#   ./create-template.sh -i 9001 -s local-lvm
#   ./create-template.sh -u https://example.com/custom.qcow2 -i 9002
